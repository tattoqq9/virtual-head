...
- 62件の自動テストに合格
- 完成EXEのGUI起動、およびYawNet 64とGold-YOLO-Nの実ダウンロード・SHA-256一致を確認
- 公開ZIPは100,892,447バイト。ONNX、第三者Skin、Virtual Head独自Pythonソースを含まない
...
```text
141fc83d8200e6fa87244c4e5bec3a9f9509e8cf3e466b15eb59fecfb12e3dfd
```
